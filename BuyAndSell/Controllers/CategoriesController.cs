...
namespace BuyAndSell.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,ParentID,Name,Child")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,ParentID,Name,Child")] Category category)
        {
            if (ModelState.IsValid)
            {
